    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end" id="perfil-menu">
          <li><a class="dropdown-item" href="perfil.php"><i class="bi bi-person-lines-fill me-2"></i> Ver Perfil</a></li>
          <li><a class="dropdown-item" href="historico.php"><i class="bi bi-calendar-check me-2"></i> Meus Agendamentos</a></li>
          <li><a class="dropdown-item" href="editar_dados.php"><i class="bi bi-pencil-square me-2"></i> Editar Dados</a></li>
